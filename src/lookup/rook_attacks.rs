...
impl LookupTable {
    ...
    pub(super) fn get_rook_attack_bb(square: Square, blockers: Bitboard) -> Bitboard {
...
mod tests {
    ...
    #[test]
    fn get_rook_attack_bb_returns_bitboard_with_attack_bits_set() {
        // get attacks for square
        let attack_bb = LookupTable::get_rook_attack_bb(A1, Bitboard::new(0x100000000000010));
        // print attack_bb with empty blockers for debugging purposes
        println!("{attack_bb}");
        for square_index in 0..NUM_SQUARES {
            // get attacks for square
            let attack_bb = LookupTable::get_rook_attack_bb(Square::new(square_index), Bitboard::new(0));
            // print attack_bb with empty blockers for debugging purposes
            println!("{attack_bb}");
        }
        ...
        assert_eq!(0x1010101010101fe, LookupTable::get_rook_attack_bb(A1, Bitboard::new(0)).value);
        assert_eq!(0x1010101010101fe, LookupTable::get_rook_attack_bb(A1, Bitboard::new(0x100000000000080)).value);
        assert_eq!(0x10101010101011e, LookupTable::get_rook_attack_bb(A1, Bitboard::new(0x100000000000010)).value);
        assert_eq!(0x1011e, LookupTable::get_rook_attack_bb(A1, Bitboard::new(0x10010)).value);
        assert_eq!(0x80808f708080808, LookupTable::get_rook_attack_bb(D5, Bitboard::new(0)).value);
        assert_eq!(0x80808f708080808, LookupTable::get_rook_attack_bb(D5, Bitboard::new(0x800008100000008)).value);
        assert_eq!(0x8083608000000, LookupTable::get_rook_attack_bb(D5, Bitboard::new(0x80800e308080808)).value);
        assert_eq!(0x40be4040404040, LookupTable::get_rook_attack_bb(G6, Bitboard::new(0x40020000000000)).value);
        assert_eq!(0x40404041a0404, LookupTable::get_rook_attack_bb(C3, Bitboard::new(0x4000000120004)).value);
    }
}