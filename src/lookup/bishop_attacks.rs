...
impl LookupTable {
    ...
    pub(super) fn get_bishop_attack_bb(square: Square, blockers: Bitboard) -> Bitboard {
...
mod tests {
    ...
    #[test]
    fn get_bishop_attack_bb_returns_bitboard_with_attack_bits_set() {
        for square_index in 0..NUM_SQUARES {
            // get attacks for square
            let attack_bb = LookupTable::get_bishop_attack_bb(Square::new(square_index), Bitboard::new(0));
        ...
        assert_eq!(0x182442800284482, LookupTable::get_bishop_attack_bb(E4, Bitboard::new(0)).value);
        assert_eq!(0x182442800284080, LookupTable::get_bishop_attack_bb(E4, Bitboard::new(0x80000)).value);
        assert_eq!(0x82442800284080, LookupTable::get_bishop_attack_bb(E4, Bitboard::new(0x2000000080000)).value);
        assert_eq!(0x4000402010080000, LookupTable::get_bishop_attack_bb(H7, Bitboard::new(0x80000)).value);
        assert_eq!(0x10a000a010080402, LookupTable::get_bishop_attack_bb(G6, Bitboard::new(0)).value);
        assert_eq!(0x10a000a000000000, LookupTable::get_bishop_attack_bb(G6, Bitboard::new(0x2000000000)).value);
        assert_eq!(0xa000a000000000, LookupTable::get_bishop_attack_bb(G6, Bitboard::new(0xa000a000000000)).value);
        assert_eq!(0x14224080000000, LookupTable::get_bishop_attack_bb(D8, Bitboard::new(0x20080000000)).value);
    }
}