...
impl Search {
    ...
    pub fn iterative_search(&mut self, board: Board, max_depth: u64, time_limit: Duration, mut board_history: ArrayVec<u64, 800>) {
    ...
    pub fn negamax(&mut self, board: Board, depth: u64, ply_index: u64, mut alpha: i32, beta: i32, time_limit: Duration, board_history: &mut ArrayVec<u64, 800>) -> i32 {
